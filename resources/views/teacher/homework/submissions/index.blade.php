  ...
  <div class="app-content-header">
    <div class="container-fluid">
      <div class="row">
        ...
        <div class="col-sm-6">
          <a class="btn btn-outline-secondary float-sm-end" href="{{ route('teacher.homework.list') }}">Back to List</a>
        </div>
      </div>
    </div>
  </div>
      ...
      <div class="row">
        <div class="col-md-12">
          ...
          <div class="card card-primary card-outline mb-4">
            ...
            <div class="card-body">
              <form method="GET" action="{{ route('teacher.homework.submissions.index', $homework->id) }}">
                <div class="row g-3">
                  <div class="col-md-4">
                  ...
                  <div class="col-md-2 d-flex align-items-end">
                    ...
                    <a href="{{ route('teacher.homework.submissions.index', $homework->id) }}" class="btn btn-outline-secondary">Reset</a>
                  </div>
                </div>
              </form>
            </div>
                  ...
                  <tbody>
                    @forelse($students as $row)
                      @php
                        ...
                        $plain = $row->text_content
                          ? trim(Str::limit(strip_tags(html_entity_decode($row->text_content, ENT_QUOTES | ENT_HTML5, 'UTF-8')), 120))
                          : '—';
                      @endphp
                      <tr>
                        ...
                        <td>
                          @if($row->submission_id && $row->attachment)
                            <a href="{{ route('teacher.homework.submissions.download', $row->submission_id) }}"
