@extends('admin.layout.layout') {{-- reuse your layout --}}
@section('content')
      ...
      <div class="row">
        <div class="col-md-12">
          ...
          <div class="card card-primary card-outline mb-4">
            ...
            <div class="card-body">
              <form method="GET" action="{{ route('teacher.student-attendance.view') }}" class="row g-3 align-items-end">
                <div class="col-md-6">
                ...
                <div class="col-md-2">
                  ...
                  <a href="{{ route('teacher.student-attendance.view') }}" class="btn btn-success">Reset</a>
                </div>
              </form>
            </div>
          </div>
          ...
          @if(($selectedClassId ?? null) && ($selectedDate ?? null))
            <div class="card">
              ...
              <div class="card-body p-0">
                <form method="POST" action="{{ route('teacher.student-attendance.save') }}">
                  @csrf
