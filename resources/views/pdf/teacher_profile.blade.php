...
<div class="wrap">
    <h2 style="text-align:center; margin-top:0;">Teacher Profile</h2>

    {{-- Teacher --}}
    <div class="left">
        <div class="img">
            @if(!empty($photoSrc))
                <img src="{{ $photoSrc }}" alt="Teacher Photo" width="140" height="160" style="object-fit:cover;">
            @else
    ...
    <div class="right">
        <table class="tbl">
            ...
            <tr><td class="label">Role</td><td>Teacher</td></tr>
        </table>
    </div>
    <div class="clear"></div>
</div>
