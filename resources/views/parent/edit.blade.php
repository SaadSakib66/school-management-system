            ...
            <div class="row g-4">
                ...
                <div class="col-md-8">
                    <div class="card card-primary card-outline mb-4">
                        ...
                        <form action="{{ route('parent.update-account') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" name="occupation" class="form-control" placeholder="Occupation" value="{{ old('occupation', $user->occupation ?? '') }}" required />
                                </div>
