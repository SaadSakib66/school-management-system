...
<div class="app-content-header">
    ...
    <div class="row">
        ...
        <div class="col-sm-6">
        <button class="btn btn-primary float-sm-end"><a href="{{ route('admin.subject.add') }}" style="text-decoration: none; color: white;">Add Subject</a></button>
        </div>
    </div>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <form action="{{ route('admin.subject.delete-subject') }}" method="POST" style="display:inline;">
                                        @csrf
