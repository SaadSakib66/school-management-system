      ...
      <div class="row g-4">
        <div class="col-md-12">
          ...
          <div class="card card-primary card-outline mb-4">
            <form
              action="{{ isset($homework)
                        ? route('admin.homework.update', $homework->id)
                        : route('admin.homework.store') }}"
              ...
              <div class="card-body">
                ...
                <div class="mb-3">
                  ...
                  <select id="class_id" name="class_id" class="form-control @error('class_id') is-invalid @enderror" required>
                    ...
                    @foreach ($getClass as $c)
                      <option value="{{ $c->id }}"
                        {{ (string)$selectedClassId === (string)$c->id ? 'selected' : '' }}>
                ...
                {{-- Subject (populated from class_subjects) --}}
                <div class="mb-3">
                ...
                <div class="mb-3">
                  ...
                  @if(isset($homework) && $homework->document_file)
                    <div class="form-text mt-1">
                      Current: <a href="{{ route('admin.homework.download', $homework->id) }}">Download file</a>
                    </div>
  ...
  <script>
    ...
    document.addEventListener('DOMContentLoaded', function () {
      ...
      function loadSubjects(classId) {
        ...
        fetch("{{ route('admin.homework.class_subjects') }}?class_id=" + classId, {
