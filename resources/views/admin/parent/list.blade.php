...
<div class="app-content-header">
    ...
    <div class="row">
        ...
        <div class="col-sm-6">
        <button class="btn btn-primary float-sm-end"><a href="{{ route('admin.parent.add') }}" style="text-decoration: none; color: white;">Add Parent</a></button>
        </div>
    </div>
                                ...
                                @foreach($getRecord as $value)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="{{ route('admin.parent.add-my-student', $value->id) }}" class="btn btn-success btn-sm">My Student</a>

                                            <form action="{{ route('admin.parent.delete-parent') }}" method="POST" style="display:inline;">
                                                @csrf
