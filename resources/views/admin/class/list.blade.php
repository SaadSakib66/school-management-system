...
<div class="app-content-header">
    ...
    <div class="row">
        ...
        <div class="col-sm-6">
        <button class="btn btn-primary float-sm-end"><a href="{{ route('admin.class.add') }}" style="text-decoration: none; color: white;">Add Class</a></button>
        </div>
    </div>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <form action="{{ route('admin.class.delete-class') }}" method="POST" style="display:inline;">
                                        @csrf
